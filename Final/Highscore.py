...
class Highscore:
    ...
    def draw(self, surface):
        ...
        surface.blit(self.p1w, (self.x + self.size * 9.4, self.y + self.size * 0))
        surface.blit(self.p1l, (self.x + self.size * 10.9, self.y + self.size * 0))
        surface.blit(self.p2n, (self.x, self.y + self.size * 1))
        surface.blit(self.p2w, (self.x + self.size * 9.4, self.y + self.size * 1))
        surface.blit(self.p2l, (self.x + self.size * 10.9, self.y + self.size * 1))
        surface.blit(self.p3n, (self.x, self.y + self.size * 2))
        surface.blit(self.p3w, (self.x + self.size * 9.4, self.y + self.size * 2))
        surface.blit(self.p3l, (self.x + self.size * 10.9, self.y + self.size * 2))
        surface.blit(self.p4n, (self.x, self.y + self.size * 3))
        surface.blit(self.p4w, (self.x + self.size * 9.4, self.y + self.size * 3))
        surface.blit(self.p4l, (self.x + self.size * 10.9, self.y + self.size * 3))
        surface.blit(self.p5n, (self.x, self.y + self.size * 4))
        surface.blit(self.p5w, (self.x + self.size * 9.4, self.y + self.size * 4))
        surface.blit(self.p5l, (self.x + self.size * 10.9, self.y + self.size * 4))
        surface.blit(self.p6n, (self.x, self.y + self.size * 5))
        surface.blit(self.p6w, (self.x + self.size * 9.4, self.y + self.size * 5))
        surface.blit(self.p6l, (self.x + self.size * 10.9, self.y + self.size * 5))
        surface.blit(self.p7n, (self.x, self.y + self.size * 6))
        surface.blit(self.p7w, (self.x + self.size * 9.4, self.y + self.size * 6))
        surface.blit(self.p7l, (self.x + self.size * 10.9, self.y + self.size * 6))
        surface.blit(self.p8n, (self.x, self.y + self.size * 7))
        surface.blit(self.p8w, (self.x + self.size * 9.4, self.y + self.size * 7))
        surface.blit(self.p8l, (self.x + self.size * 10.9, self.y + self.size * 7))
        surface.blit(self.p9n, (self.x, self.y + self.size * 8))
        surface.blit(self.p9w, (self.x + self.size * 9.4, self.y + self.size * 8))
        surface.blit(self.p9l, (self.x + self.size * 10.9, self.y + self.size * 8))
        surface.blit(self.p10n, (self.x, self.y + self.size * 9))
        surface.blit(self.p10w, (self.x + self.size * 9.4, self.y + self.size * 9))
        surface.blit(self.p10l, (self.x + self.size * 10.9, self.y + self.size * 9))
