...
class Highscore:
    ...
    def update(self):
        ...
        self.p1wl = self.font.render(self.resultLineswl[0], 1, (0,0,0))
        ...
        self.p2wl = self.font.render(self.resultLineswl[1], 1, (0,0,0))
        ...
        self.p3wl = self.font.render(self.resultLineswl[2], 1, (0,0,0))
        ...
        self.p4wl = self.font.render(self.resultLineswl[3], 1, (0,0,0))
        ...
        self.p5wl = self.font.render(self.resultLineswl[4], 1, (0,0,0))
        ...
        self.p6wl = self.font.render(self.resultLineswl[5], 1, (0,0,0))
        ...
        self.p7wl = self.font.render(self.resultLineswl[6], 1, (0,0,0))
        ...
        self.p8wl = self.font.render(self.resultLineswl[7], 1, (0,0,0))
        ...
        self.p9wl = self.font.render(self.resultLineswl[8], 1, (0,0,0))
        ...
        self.p10wl = self.font.render(self.resultLineswl[9], 1, (0,0,0))
